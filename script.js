(function () {
  ...
  var RULES = [
    ...
    { n: 2, category: 'Tempo', title: 'At-Tahqiq', ar: 'التَّحْقِيقُ', keyword: 'Langzaam', definition: 'Langzaamste recitatietempo.', trigger: 'Bij leren en corrigeren.', how: 'Spreek elk teken volledig uit.', example: 'Lees [heel duidelijk].', memory: 'Tahqiq = leer-tempo.', articulation: { type: 'tongue', label: 'Controle', tip: 'Langzaam voor precisie.' } },
    { n: 3, category: 'Tempo', title: 'At-Tadwir', ar: 'التَّدْوِيرُ', keyword: 'Middelmatig', definition: 'Niet te langzaam, niet te snel.', trigger: 'Dagelijkse recitatie.', how: 'Behoud balans tussen tempo en duidelijkheid.', example: 'Tempo voor [gebed en dagelijks lezen].', memory: 'Tadwir = balans.', articulation: { type: 'tongue', label: 'Balans', tip: 'Vloeiend en correct.' } },
    { n: 4, category: 'Tempo', title: 'Al-Hadr', ar: 'الْحَدْرُ', keyword: 'Snel', definition: 'Vlot lezen met behoud van regels.', trigger: 'Bij langere recitatie (khatm).', how: 'Snel maar niet slordig.', example: 'Snel met [behoud van tajwid].', memory: 'Snelheid mag regels niet breken.', articulation: { type: 'stretch', label: 'Ritme', tip: 'Geen letters inslikken.' } },
    { n: 5, category: 'Fouten', title: 'Lahn al-Jali', ar: 'اللَّحْنُ الْجَلِيُّ', keyword: 'Grote fout', definition: 'Fout die betekenis kan veranderen.', trigger: 'Bij verkeerde letter of klinker en bij toevoegen/weglaten van letter.', how: 'Direct corrigeren en herhalen.', example: '[Harf] of [harakah] verandert.', memory: 'Jali = ernstig zichtbaar.', articulation: { type: 'throat', label: 'Precisie', tip: 'Letter en klinker exact.' } },
    { n: 6, category: 'Fouten', title: 'Lahn al-Khafi', ar: 'اللَّحْنُ الْخَفِيُّ', keyword: 'Kleine fout', definition: 'Betekenis vaak intact, maar tajwid onjuist.', trigger: 'Bij gemiste eigenschappen/regels.', how: 'Fijn afstellen met oefening.', example: 'Gemiste [izhar/idgham/ikhfa].', memory: 'Khafi = subtiele fout.', articulation: { type: 'echo', label: 'Afwerking', tip: 'Luister op detailniveau.' } },
    { n: 7, category: 'Qiraat', title: '7 Canonieke Qiraat', ar: 'الْقِرَاءَاتُ السَّبْعُ', keyword: 'Recitatiestijlen', definition: 'Erkende overleveringen van recitatie.', trigger: 'Gevorderde studie.', how: 'Eerst Hafs stabiel beheersen.', example: '[Nafi], [Ibn Kathir], [Asim] ...', memory: 'Verschil in riwayah, één Koran.', articulation: { type: 'tongue', label: 'Consistentie', tip: 'Per riwayah consequent.' } },
    { n: 8, category: 'Overzicht', title: 'Hoofdonderdelen', ar: 'مَخَارِجُ، حَرَكَاتٌ، صِفَاتٌ، مَدٌّ، وَقْفٌ', keyword: 'Leerlijn', definition: 'Makharij, harakat, sifat, madd, waqf.', trigger: 'Bij lesplanning.', how: 'Leer in blokken.', example: '[Makharij] → [Sifat] → [Madd].', memory: 'Structuur geeft rust.', articulation: { type: 'tongue', label: 'Structuur', tip: 'Volg de leerlijn.' } },
    { n: 9, category: 'Makharij', title: '17 articulatiepunten', ar: 'مَخَارِجُ الْحُرُوفِ', keyword: '5 gebieden', definition: '17 punten verdeeld over 5 hoofdgebieden.', trigger: 'Bij letteruitspraak.', how: 'Koppel letter aan punt.', example: '[Jawf] [Halq] [Lisan] [Shafatan] [Khayshum].', memory: 'Plaats bepaalt klank.', articulation: { type: 'throat', label: 'Makhrajkaart', tip: 'Herken de bron van de klank.' } },
    { n: 10, category: 'Makharij', title: 'Al-Jawf', ar: 'الْجَوْفُ', keyword: 'Maddletters', definition: 'Mond-keelholte voor maddletters.', trigger: 'Bij lange klinkers.', how: 'Houd klankruimte open.', example: '[ا] [و] [ي].', memory: 'Jawf = ruimte voor verlenging.', articulation: { type: 'stretch', label: 'Open resonantie', tip: 'Laat klank vloeien.' } },
    { n: 11, category: 'Makharij', title: 'Al-Halq', ar: 'الْحَلْقُ', keyword: 'Keelletters', definition: 'Onder, midden en boven keel.', trigger: 'Bij ء ه / ع ح / غ خ.', how: 'Gebruik juiste keeldeel.', example: 'Onder [ء ه], midden [ع ح], boven [غ خ].', memory: 'Halq-ladder 3 niveaus.', articulation: { type: 'throat', label: 'Keelzones', tip: 'Plaats letter in juiste zone.' } },
    { n: 12, category: 'Makharij', title: 'Al-Lisan', ar: 'اللِّسَانُ', keyword: 'Tongletters', definition: 'Grootste groep letters komt van de tong.', trigger: 'Bij meerdere lettersets.', how: 'Train achter/midden/voor/zijkant.', example: 'Achter [ق ك], midden [ج ش ي], voor [ن ر].', memory: 'Tong stuurt veel letters.', articulation: { type: 'tongue', label: 'Tongcontrole', tip: 'Voel het actieve tongdeel.' } },
